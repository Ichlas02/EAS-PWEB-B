...
<body>
    <nav class="p-3 border-gray-200 bg-gray-50 dark:bg-blue-300 dark:border-gray-700">
        <div class="container flex flex-wrap flex-col md:flex-row items-center justify-between mx-auto">
            <div>
            <button id="theme-toggle" type="button" class="text-black-500 dark:text-gray-800 hover:bg-black-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-black-700 rounded-lg text-sm p-2.5">
            ...
            <button data-collapse-toggle="navbar-hamburger" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-hamburger" aria-expanded="false">
